...
#---------------------------------Sync to Table------------------------------------------------------------------------------
table_des = 'pgi-dwh.a200_staging_last30days.st_hana_pgi_orrr'
...
schema_des = [
    ...
    bigquery.SchemaField("U_InvName", "STRING", mode="NULLABLE"),
    bigquery.SchemaField("U_InvAddress", "STRING", mode="NULLABLE"),
    bigquery.SchemaField("U_Wards", "STRING", mode="NULLABLE"),
    bigquery.SchemaField("U_Districts", "STRING", mode="NULLABLE"),
